...
const gameData = {
  ...
  gameMechanics: {
    ...
    characterAbilities: {
      청룡: { attack: "번개 공격", special: "공격력, 방어력 20% 증가" },
      백호: { attack: "물리 공격", special: "보호막 제공" },
      주작: { attack: "화염 공격", special: "화염 폭풍" },
      현무: { attack: "독 공격", special: "체력 20% 회복" }
    },
    enemyList: [
...
const saveGameData = async (data) => {
  try {
    await setDoc(doc(db, "games", "chatbotGame"), data);
